...
contract FixedPointMathLibTest is Test, TestPlus {
    ...
    function _testLambertW0WadMonoAround(int256 x) internal {
        console2.log("x", x);
        console2.log("log2(x)", FixedPointMathLib.log2(uint256(x)));
    ...
    function testLambertW0WadMonotonicallyIncreasing(int256 a, int256 b) public {
        ...
        unchecked {
            ...
            if (!success) {
                console2.log("log2(a)", FixedPointMathLib.log2(uint256(a)));
                console2.log("log2(b)", FixedPointMathLib.log2(uint256(b)));
                console2.log("log2(w0a)", FixedPointMathLib.log2(uint256(w0a)));
                console2.log("log2(w0b)", FixedPointMathLib.log2(uint256(w0b)));
                assertTrue(success);
            }
        }
    }
